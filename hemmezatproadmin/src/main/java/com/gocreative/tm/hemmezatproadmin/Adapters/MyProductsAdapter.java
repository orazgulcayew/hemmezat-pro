...
public class MyProductsAdapter extends RecyclerView.Adapter<MyProductsAdapter.AllProductsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AllProductsViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDeleteDialog(holder.itemView, allProductsArrayList.get(position).getOwner_uid(), productId, position);
    ...
    private void showDeleteDialog(View view, String ownerUid, String productId, int pos){
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                documentReference = firestore.collection("admin").document("admin_products").collection("products").document(productId);
                documentReference.delete();
                dialog.dismiss();
